...
export default function Residential({ house }) {
    ...
    return (
        <div className="card card-compact w-96 bg-base-100 shadow-xl font-poppins">
            <figure><img src={house_img} alt={estate_title} /></figure>
            ...
            <div className="absolute flex justify-between items-center top-0 p-4 w-full">
                ...
                <button className="btn btn-outline text-white">{status}</button>
            </div>
        </div>
    )
}
